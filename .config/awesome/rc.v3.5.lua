...
awful.rules.rules = {
    ...
    { rule = { name = "Browserbox" }, properties = { floating = true } },
    { rule = { class = "pinentry" }, properties = { floating = true } },
    { rule = { class = "gimp" }, properties = { floating = true } },
    { rule = { class = "Dolphin", name = "Kopiervorgang" }, properties = { floating = true } },
    { rule = { class = "kruler" }, properties = { floating = true }, callback = function(c) c:geometry({x=340, y=500}) end},
    { rule = { class = "Kate" }, properties = { floating = true } },
    { rule = { class = "Brackets" }, properties = { floating = true } },
...
-- add orglendar to clock widget
orglendar.files = { "Desktop/todo/komet.org",
										"Desktop/todo/tommy.org",
										"Desktop/todo/portale.org"} -- comma separated
